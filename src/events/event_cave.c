...
static void buttons_actions(game_t *game)
{
    ...
    check_button_zero_arg(&arr_buttons[BTN_C_P_RESUME], game, mouse_pos);
    check_button_one_arg(&arr_buttons[BTN_C_P_MENU], game, mouse_pos,
        MENU_SCENE);
    check_button_zero_arg(&arr_buttons[BTN_C_P_EXIT], game, mouse_pos);
    check_button_zero_arg(&arr_buttons[BTN_C_QUEST], game, mouse_pos);
}
